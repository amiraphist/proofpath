...
const iconFor = (type: NodeType) => {
  const Icon = type === "condition" ? ShieldCheck : type === "approval" ? LockKeyhole : type === "wallet" ? WalletCards : type === "receipt" ? FileCheck2 : type === "dedupe" ? CopyCheck : type === "tool" ? Wrench : type === "agent" ? Bot : type === "retry" ? RotateCcw : type === "stop" ? X : Activity;
  return <Icon size={14} strokeWidth={2.2} />;
};

const LedgerVector = () => <svg className="ledger-vector" viewBox="0 0 80 56" role="img" aria-label="Ledger Nano Gen5 simulated signer"><rect x="13" y="3" width="54" height="50" rx="7" fill="#252525" stroke="#151515" strokeWidth="2"/><rect x="18" y="8" width="44" height="34" rx="3" fill="#e7eee9" stroke="#74a58a"/><circle cx="27" cy="17" r="2" fill="#4b6c5a"/><circle cx="27" cy="25" r="2" fill="#4b6c5a"/><path d="M35 17h19M35 25h15M23 35h29" stroke="#4b6c5a" strokeWidth="1.7" strokeLinecap="round"/><rect x="25" y="45" width="30" height="4" rx="2" fill="#d5d5d5"/><circle cx="68" cy="28" r="3" fill="#d1d1d1" stroke="#161616"/></svg>;
