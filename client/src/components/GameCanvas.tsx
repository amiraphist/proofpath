...
function GraphBoard({ stageId, nodes, edges, selectedNodeId, onSelect, onRemove, onLedgerColor, onMove, onConnect, onRemoveEdge, onConnectionUnavailable, onSound, alert, attackEvent }: { stageId: number; nodes: GraphNode[]; edges: { id: string; from: string; to: string; state: string }[]; selectedNodeId: string | null; onSelect: (id: string) => void; onRemove: (id: string) => void; onLedgerColor: (id: string, color: LedgerColor) => void; onMove: (id: string, x: number, y: number) => void; onConnect: (from: string, to: string) => void; onRemoveEdge: (id: string) => void; onConnectionUnavailable: (notice: string) => void; onSound: (name: "tap" | "connect-start" | "connect-done" | "error" | "delete") => void; alert?: boolean; attackEvent?: string }) {
