...
const LedgerMini = () => <svg className="ledger-mini" viewBox="0 0 54 74" role="img" aria-label="Ledger Nano Gen5"><rect x="5" y="2" width="44" height="70" rx="8" fill="#202020" stroke="#111" strokeWidth="2"/><rect x="11" y="9" width="32" height="38" rx="3" fill="#e8eee8" stroke="#8c9d91"/><circle cx="27" cy="17" r="3.5" fill="#59635d"/><text x="27" y="19.5" textAnchor="middle" fontSize="5" fontWeight="800" fill="#f4f6f1">₿</text><path d="M15 27h24M15 33h24M15 39h24" stroke="#66736b" strokeWidth="1.4"/><rect x="21" y="57" width="12" height="4" rx="2" fill="#858585"/><rect x="46" y="27" width="4" height="13" rx="2" fill="#747474"/></svg>;
...
const LedgerVector = () => <svg className="ledger-vector" viewBox="0 0 120 190" role="img" aria-label="Ledger Nano Gen5 simulated hardware signer"><defs><linearGradient id="ledger-front-shell" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#454545"/><stop offset=".5" stopColor="#202020"/><stop offset="1" stopColor="#101010"/></linearGradient><linearGradient id="ledger-front-screen" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#f5f8f3"/><stop offset="1" stopColor="#dce5dd"/></linearGradient></defs><rect x="11" y="3" width="98" height="184" rx="18" fill="#080808" opacity=".18" transform="translate(2 2)"/><rect x="7" y="2" width="98" height="184" rx="18" fill="url(#ledger-front-shell)" stroke="#111" strokeWidth="3"/><rect x="15" y="13" width="82" height="112" rx="8" fill="#111" stroke="#080808" strokeWidth="2"/><rect x="20" y="19" width="72" height="100" rx="5" fill="url(#ledger-front-screen)" stroke="#a6b4a9" strokeWidth="1.5"/><circle cx="56" cy="37" r="9" fill="#5d665f"/><text x="56" y="41" textAnchor="middle" fontSize="12" fontWeight="800" fill="#f1f4ef">₿</text><text x="56" y="58" textAnchor="middle" fontSize="7.5" fontWeight="800" fill="#27332d">Sign transaction to</text><text x="56" y="68" textAnchor="middle" fontSize="7.5" fontWeight="800" fill="#27332d">send payment?</text><path d="M21 79 H91" stroke="#abb9ae" strokeWidth="1"/><text x="42" y="96" textAnchor="middle" fontSize="7" fontWeight="700" fill="#27332d">Hold to sign</text><rect x="72" y="85" width="12" height="12" rx="2" fill="#303a35"/><path d="m75 91 3 3 5-7" fill="none" stroke="#edf4eb" strokeWidth="1.5"/><path d="M21 105 H58" stroke="#abb9ae" strokeWidth="1"/><text x="34" y="114" textAnchor="middle" fontSize="6.5" fill="#27332d">Reject</text><text x="76" y="114" textAnchor="middle" fontSize="6.5" fill="#27332d">4 of 4</text><rect x="44" y="143" width="24" height="6" rx="3" fill="#060606" stroke="#777" strokeWidth="1.2"/><rect x="49" y="145" width="14" height="2" rx="1" fill="#bfc5bf" opacity=".7"/><rect x="101" y="61" width="6" height="25" rx="3" fill="#0b0b0b" stroke="#6a6a6a" strokeWidth="1.2"/><path d="M28 159 H84" stroke="#737373" strokeWidth="1.4" opacity=".45"/><path d="M30 164 H82" stroke="#737373" strokeWidth="1.4" opacity=".35"/></svg>;
