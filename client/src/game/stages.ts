...
export const stages: Stage[] = [
  ...
  { id: 12, title: "Deepfake Approval", client: "Fix 04 · Fake owner message", severity: "high", mode: "fix", story: "A voice clone claims the owner approved payment and exploits a graph with no trusted approval channel.", objective: "Put Policy guard first, then restore Check payment and real Owner approval before Ledger signing.", lesson: "A claimed identity is not a verified identity. Approval must come through a fixed trusted channel.", buildSequence: [agent, policy, check, ask, ledger, pay], attackSequence: [agent, check, ledger, pay], attackEvent: "ATTACK EVENT: A deepfake approval message arrived through an untrusted channel.", fixFault: "HACK ALERT: The route trusts a message instead of Policy guard and Owner approval. Put Policy guard first, then restore the remaining controls before signing.", available: [policy, ask, check, ledger, stop, pay] },
