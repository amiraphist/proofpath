...
export type Stage = {
  ...
  mode: GameMode;
  hardeningRoutes?: HardeningRoute[];
};
...
export const nodeMeta: Record<NodeType, { label: string; short: string; color: string; icon: string; help: string }> = {
  ...
  seal: { label: "Seal exact action", short: "SEAL", color: "violet", icon: "⌁", help: "Lock the approved amount, recipient, action, expiry, and one-time use." },
...
const hardeningByStage: Partial<Record<number, HardeningRoute[]>> = {
  2: [
    { stars: 4, sequence: [agent, limit, verify, ledger, pay], label: "STRONG", detail: "You capped the renewal and verified where it will go." },
    { stars: 5, sequence: [agent, policy, limit, verify, ledger, pay], label: "HARDENED", detail: "A trusted policy now screens the plan before its cap and recipient checks." },
  ],
  3: [
    { stars: 4, sequence: [agent, verify, check, ledger, pay], label: "STRONG", detail: "You verified both the recipient and the payment details." },
    { stars: 5, sequence: [agent, policy, verify, check, ledger, pay], label: "HARDENED", detail: "A policy gate now filters the agent plan before destination and detail checks." },
  ],
  4: [
    { stars: 4, sequence: [agent, rate, preview, ledger, pay], label: "STRONG", detail: "You inspect the exact swap after enforcing the price boundary." },
    { stars: 5, sequence: [agent, policy, rate, preview, ledger, pay], label: "HARDENED", detail: "A policy gate, rate check, and exact preview defend the swap before signing." },
  ],
  5: [
    { stars: 4, sequence: [agent, limit, ask, preview, ledger, pay], label: "STRONG", detail: "The owner now sees the exact controlled-spending action before signing." },
    { stars: 5, sequence: [agent, policy, limit, ask, preview, ledger, pay], label: "HARDENED", detail: "A policy gate protects the delegated-spending plan before every human and hardware check." },
  ],
  6: [
    { stars: 4, sequence: [agent, verify, check, limit, ask, ledger, pay], label: "STRONG", detail: "The cross-border payment is recipient-verified, checked, capped, and approved." },
    { stars: 5, sequence: [agent, policy, verify, check, limit, ask, ledger, pay], label: "HARDENED", detail: "A policy gate adds a trusted first boundary to the cross-border route." },
  ],
  7: [
    { stars: 4, sequence: [agent, check, quorum, preview, ledger, pay], label: "STRONG", detail: "The quorum now reviews an exact preview before the treasury signer." },
    { stars: 5, sequence: [agent, verify, check, quorum, preview, ledger, pay], label: "HARDENED", detail: "The treasury route also verifies the destination before governance signs." },
  ],
  8: [
    { stars: 4, sequence: [agent, policy, verify, limit, quorum, preview, ledger, pay], label: "STRONG", detail: "A policy boundary now protects the already layered treasury migration." },
    { stars: 5, sequence: [agent, policy, verify, limit, quorum, preview, seal, ledger, pay], label: "HARDENED", detail: "The approved treasury move is now sealed exactly before hardware signing." },
  ],
  9: [
    { stars: 4, sequence: [agent, policy, check, preview, ask, ledger, pay], label: "STRONG", detail: "The owner reviews an exact preview after trusted policy and payment checks." },
    { stars: 5, sequence: [agent, policy, check, preview, ask, seal, ledger, pay], label: "HARDENED", detail: "The real approval is now sealed to the exact action before signing." },
  ],
  10: [
    { stars: 4, sequence: [agent, policy, verify, check, ask, ledger, pay], label: "STRONG", detail: "Policy, recipient verification, and payment checks work together before approval." },
    { stars: 5, sequence: [agent, policy, verify, check, preview, ask, seal, ledger, pay], label: "HARDENED", detail: "The verified destination is previewed and sealed before hardware signing." },
  ],
  11: [
    { stars: 4, sequence: [agent, policy, rate, preview, ledger, pay], label: "STRONG", detail: "The swap now has a trusted policy boundary as well as rate and preview checks." },
    { stars: 5, sequence: [agent, policy, rate, preview, ask, seal, ledger, pay], label: "HARDENED", detail: "A human-approved, sealed action closes the remaining allowance risk." },
  ],
  12: [
    { stars: 4, sequence: [agent, policy, check, preview, ask, ledger, pay], label: "STRONG", detail: "The real owner reviews an exact preview after the deepfake is filtered." },
    { stars: 5, sequence: [agent, policy, check, preview, ask, seal, ledger, pay], label: "HARDENED", detail: "The owner’s real approval is locked to one exact action before signing." },
  ],
  14: [
    { stars: 4, sequence: [agent, check, preview, ask, expiry, ledger, pay], label: "STRONG", detail: "The owner previews the payment before the approval can expire." },
    { stars: 5, sequence: [agent, check, preview, ask, expiry, seal, ledger, pay], label: "HARDENED", detail: "A fresh approval is sealed to the exact action before it reaches hardware." },
  ],
  15: [
    { stars: 4, sequence: [agent, policy, check, preview, ask, seal, ledger, pay], label: "STRONG", detail: "A trusted policy boundary now protects the already sealed approval route." },
    { stars: 5, sequence: [agent, policy, verify, check, preview, ask, seal, ledger, pay], label: "HARDENED", detail: "The final route verifies the recipient as well as sealing exactly what the owner approved." },
  ],
  16: [
    { stars: 4, sequence: [agent, check, quorum, preview, ledger, pay], label: "STRONG", detail: "The full quorum now reviews an exact payment preview before hardware signing." },
    { stars: 5, sequence: [agent, policy, check, quorum, preview, ledger, pay], label: "HARDENED", detail: "A policy gate, full quorum, and preview defend the final large-payment route." },
  ],
};
